...
var amp;
var music;
var smiles = []; // list of meow sounds
var hits = []; // list of hit sound fx

function preload() {
	music = loadSound('happy.mp3');

	smiles.push(loadSound("smile-1.wav"));
	smiles.push(loadSound("smile-2.wav"));
	smiles.push(loadSound("smile-3.wav"));

	hits.push(loadSound("hit_1.wav"));
	hits.push(loadSound("hit_2.wav"));
	hits.push(loadSound("hit_3.mp3"));
